...
query = (spark.readStream.table("bronze")
        ...
        .select("v.*")
     .writeStream
        .option("checkpointLocation", "dbfs:/mnt/demo_pro/checkpoints/orders_silver_new")
        .trigger(availableNow=True)
        .table("orders_silver_new"))
...
# MAGIC %sql
# MAGIC SELECT *
# MAGIC FROM orders_silver_new

# COMMAND ----------

# MAGIC %fs ls dbfs:/user/hive/warehouse/bookstore_eng_pro.db/orders_silver
